...
│─ ● **Repositories** (Capa de Persistencia): Los repositorios interactúan directamente<br>│ con la base de datos.<br>│ Implementan operaciones CRUD y consultas personalizadas usando anotaciones como<br>│ `@Query`.<br>│<br>
